      ...
      <div class="container">
        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-top">
            ...
            <a href="#" class="logo">
              <img src="{{ asset('assets/img/landing-page/logo-blue.svg') }}" alt="Tourly logo">
            </a>
    ...
    <article>
          ...
          <ul class="popular-list">
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="{{ asset('assets/img/landing-page/ijen-photo.webp') }}" alt="Kawah Ijen, Banyuwangi" loading="lazy">
                </figure>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="{{ asset('assets/img/landing-page/pulau-merah.jpeg') }}" alt="Pulau Merah, Banyuwangi" loading="lazy">
                </figure>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="{{ asset('assets/img/landing-page/djawatan.jpeg') }}" alt="Djawatan, Banyuwangi" loading="lazy">
                </figure>
      ...
      <section class="package" id="recommendation">
        <div class="container">
          ...
          <ul class="package-list">
            ...
            <li>
              <div class="package-card">
                ...
                <figure class="card-banner">
                  <img src="{{ asset('assets/img/team-1.jpg') }}" alt="Rovita Mei Andini" loading="lazy">
                </figure>
            ...
            <li>
              <div class="package-card">
                ...
                <figure class="card-banner">
                  <img src="{{ asset('assets/img/team-1.jpg') }}" alt="Summer Holiday To The Oxolotan River" loading="lazy">
                </figure>
            ...
            <li>
              <div class="package-card">
                ...
                <figure class="card-banner">
                  <img src="{{ asset('assets/img/team-3.jpg') }}" alt="Santorini Island's Weekend Vacation" loading="lazy">
                </figure>
          ...
          <button class="btn btn-primary">View All Guides</button>
